...
public class T3_RadioButton_utility_method {
    ...
    private static void clickAndVerifyRadioButton(WebDriver driver, String nameAttribute, String expectedID){
        ...
        List<WebElement> radioButtons = driver.findElements(By.name(nameAttribute));//name has to be comman
    ...
    //         String actualID  = each.getAttribute(name"id");
    //         System.out.println("Actual id is "+ actualID);
    //      if(actualID.equals(hockey)){
   //         each.click();
    //        System.out.println(actualID + "Is selected : "+each.is selected());
